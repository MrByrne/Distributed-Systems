...
public class ClientGUI implements ActionListener{
	...
	private void build() { 
		...
		JFrame frame = new JFrame("Smart Agriculture App - x22145508");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (entry1.getText().equals("Weather")) {
			...
			if (label.equals("Run Check")) {
				System.out.println("Weather Service to be invoked ...");
			...
			reply1.setText(String.valueOf("Error: Please Type 'Weather' to check moisture levels"));
